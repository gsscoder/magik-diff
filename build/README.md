...
This directory holds the build files and assets for the application.
...
You can customise them for the build; delete them and run `wails build` to restore the defaults.
...
You can customise them for the application; delete them and run `wails build` to restore the defaults.
